<nav class="main-header navbar navbar-expand fixed-top bg-info">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <a type="button" href="#" class="dropdown-item dropdown-footer" data-toggle="modal"
                    data-target="#profileModal">Profil</a>
                <!-- Ganti Password -->
                <a type="button"
                    href="<?= base_url(); ?>Settings/view_pegawai/<?= $this->session->userdata('id_user'); ?>"
                    class="dropdown-item dropdown-footer">Password</a>
                <!-- Button Logout -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?= base_url(); ?>Settings/lengkapi_data" method="POST" enctype="multipart/form-data">
                    <input type="hidden" value="<?= $this->session->userdata('id_user'); ?>" name="id">
                    <div class="form-group">
                        <label for="nama_lengkap">Nama Lengkap</label>
                        <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap"
                            value="<?= $i['nama_lengkap'] ?>" required>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="id_jenis_kelamin" name="id_jenis_kelamin" required>
                            ...
                            <option value="<?= $u['id_jenis_kelamin'] ?>"
                                <?php if ($u['id_jenis_kelamin'] == $i['id_jenis_kelamin']) echo 'selected'; ?>>
                                <?= $u['jenis_kelamin'] ?>
                            </option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="jabatan" name="jabatan" value="<?= $i['jabatan'] ?>"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat</label>
                        <textarea class="form-control" id="alamat" rows="3" name="alamat"
                            required><?= $i['alamat'] ?></textarea>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-4 text-center">
                        <div class="form-group">
                            <img src="<?= base_url('assets/upload/' . $i['pangkat']); ?>" class="img-fluid"
                                alt="Foto Profil">
                        </div>
                    </div>
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="profile_no_telp" value="<?= $i['no_telp'] ?>"
                                disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="profile_jabatan" value="<?= $i['jabatan'] ?>"
                                disabled>
                        </div>
                        <div class="form-group">
                            <label for="profile_alamat">Alamat</label>
                            <textarea class="form-control" id="profile_alamat" rows="3"
                                disabled><?= $i['alamat'] ?></textarea>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>

    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <!-- Ganti Password -->
                <a href="<?= base_url(); ?>Settings/view_super_admin" class="dropdown-item dropdown-footer">Ganti
                    Passwod</a>
                <!-- Logout  -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php foreach ($super_admin_data as $i) : ?>
                    <form action="<?= base_url(); ?>Settings/lengkapi_data_super_admin" method="POST" enctype="multipart/form-data">
